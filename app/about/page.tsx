  ...
  return (
    <main className="py-16 px-4">
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <section className="bg-primary/5 border border-primary/10 border-l-4 border-l-primary rounded-lg p-6 sm:p-8 shadow-sm">
            <p className="text-lg leading-relaxed text-foreground">
              ...
              <span className="block mt-4 not-italic font-semibold text-primary">
